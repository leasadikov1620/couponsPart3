...
import com.lea.couponsPart2.services.serviceDAO.CustomerService;
...
public class CustomerServiceImpl extends ClientService implements CustomerService {
    ...
    public List<Coupon> getAllCustomerCouponsByCategory(Categories category) throws NotExistException {
        List<Coupon> customerCouponsByCategory = couponRepo.findAllCustomerCouponsByCategory(this.customerID, category.getName());
