package com.lea.couponsPart2.services.serviceImpl;
...
import com.lea.couponsPart2.exceptions.ExceptionType;
import com.lea.couponsPart2.exceptions.InvalidDateException;
import com.lea.couponsPart2.exceptions.NotExistException;
import com.lea.couponsPart2.services.ClientService;
import com.lea.couponsPart2.services.serviceDAO.CompanyService;
...
//            throw new InvalidDateException(ExceptionType.COUPON);
//        }
    ...
    public List<Coupon> getAllCompanyCouponsByCategory(Categories category) throws NotExistException {
      ...
      //  List<Coupon> companyCouponsByCategory = couponRepo.findAllByCompanyIdAndCategoryId(this.companyID, category.getValue());
       ...
       // List<Coupon> companyCouponsByCategory = couponRepo.findAllByCompanyId(this.companyID).stream().filter(item-> item.getCategory()==category);
