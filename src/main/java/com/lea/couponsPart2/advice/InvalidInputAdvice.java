package com.lea.couponsPart2.advice;
...
public class InvalidInputAdvice {
    ...
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public ErrorDetails handleInvalidDateException(Exception err) {
        return new ErrorDetails("Invalid Date Error", "Please make sure your input is valid (start date cannot be after end date)");
    }
}
